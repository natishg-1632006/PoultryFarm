        ...
        <div className='max-h-screen p-5 mt-16 mb-5 flex justify-center items-center'>
            <div className='w-100 shadow-lg p-3 rounded-xl' >
                ...
                <form className='flex flex-col gap-3 ' onSubmit={handleSubmit}>
                    ...
                    <input type='number' id='feedcount' name='feedcount' value={dailyEntry.feedcount} onChange={handelChange} placeholder='Enter feed' className='outline-2 outline-amber-600 rounded-lg p-2 ' />

                    <label htmlFor="feedType" className='font-bold'>Feed type</label>
                    <select id="feedType" name='feedtype' value={dailyEntry.feedtype} onChange={handelChange} className='outline-2 outline-amber-600 rounded-lg p-3 0'>
                    ...
                    <div className='border-2 p-2 border-amber-600 rounded-lg flex justify-between'>
                        <input type='number' id="avgweight" name='avgweight' value={dailyEntry.avgweight} onChange={handelChange} placeholder='Enter avg weight' className='outline-none w-full p-0' />
                    ...
                    <div className='flex flex-col gap-2 border-2 p-2 w-full border-amber-600 rounded-lg justify-between'>
                        <input type="date" id="createdAt" name='createdAt' value={dailyEntry.createdAt} onChange={handelChange} className='outline-none' />
                    </div>

                    <label htmlFor="feedback" className='font-bold'>Feedback</label>
                    <textarea type='number' id='feedback' name='feedback' value={dailyEntry.feedback} onChange={handelChange} placeholder='Enter feedback' className='outline-2 outline-amber-600 rounded-lg p-2 ' />
